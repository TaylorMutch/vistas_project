/**
 * Original source: http://learningthreejs.com/data/THREEx/docs/THREEx.screenshot.html
 */
...
(function(){
	...
	*/
	var toDataURL	= function(renderer, mimetype)
	{
		...
		console.log('Scene captured, opening new window...');
	 ...
	 * @param {Number} dstW the destination width of the image
	 * @param {Number} dstH the destination height of the image
